...
//  Project10
//
//  Created by Lareen Melo on 10/7/19.
...
//        defaults.set(frequencies, forKey: "SavedArray")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.layer.borderColor = UIColor(red: 224.0, green: 141.0, blue: 171, alpha: 0.3).cgColor
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        ac.addAction(UIAlertAction(title: "Rename person", style: .default, handler: { [weak self]
            action in
